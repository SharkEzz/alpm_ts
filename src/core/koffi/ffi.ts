...
export const alpm_option_get_cachedirs = lib.func("alpm_list_t *alpm_option_get_cachedirs(alpm_handle_t *handle)");
...
export const alpm_pkg_compute_requiredby = lib.func("alpm_list_t *alpm_pkg_compute_requiredby(alpm_pkg_t *pkg)");
export const alpm_pkg_compute_optionalfor = lib.func("alpm_list_t *alpm_pkg_compute_optionalfor(alpm_pkg_t *pkg)");
...
export function checkVersion(): void {
  ...
  const runtime = alpm_version() as string | null;
